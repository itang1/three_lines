    ...
    <div className="max-w-xl mx-auto px-6 py-16">
      ...
      <div className="space-y-5 text-base text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        <p>
          ...
          alternative storyteller to instill in a listener an entirely different set of
          beliefs than those the original storyteller would have intended, all while it
          being the case that both storytellers&apos; accounts contain only truthful
          statements. Each narrator, shaped by their own peculiarities, experiences,
          dispositions, and intentions, will selectively include or exclude certain
          details, choose words that yield particular connotations, organize events to
          emphasize certain themes over others, draw connections that another might not
          even see. This is not to say that there is no such thing as objective truth;
          but rather it is to insist that truth is always <em>narrated</em>, and that
          <em>how</em> it is narrated can vary widely based <em>who</em> is doing the
          narration.
        </p>
